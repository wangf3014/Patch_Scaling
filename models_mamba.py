...
__all__ = [
    'adventurer_tiny_patch16', 'adventurer_small_patch16',
    'adventurer_base_patch16', 'adventurer_large_patch16',
    'adventurer_tiny_patch1', 'adventurer_small_patch1',
    'adventurer_base_patch1', 'adventurer_large_patch1',
]
...
@register_model
def adventurer_tiny_patch1(pretrained=False, **kwargs):
    model = Adventurer(
        patch_size=1, embed_dim=256, depth=12, rms_norm=True, **kwargs)
    model.default_cfg = _cfg()
    return model

@register_model
def adventurer_small_patch1(pretrained=False, **kwargs):
    model = Adventurer(
        patch_size=1, embed_dim=512, depth=12, rms_norm=True, **kwargs)
    model.default_cfg = _cfg()
    return model

@register_model
def adventurer_base_patch1(pretrained=False, **kwargs):
    model = Adventurer(
        patch_size=1, embed_dim=768, depth=12, rms_norm=True, **kwargs)
    model.default_cfg = _cfg()
    return model

@register_model
def adventurer_large_patch1(pretrained=False, **kwargs):
    model = Adventurer(
        patch_size=1, embed_dim=1024, depth=24, rms_norm=True, **kwargs)
    model.default_cfg = _cfg()
    return model
